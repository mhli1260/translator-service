    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a helpful assistant that accurately detects the language of the text provided. Your answer must only be the name of the language detected in English."
                },
                {
                    "role": "user",
                    "content": post
